      ...
      <section style={{
       ...
       <h1 style={{
        ...
        <div style={{ display: "flex", gap: "15px", marginTop: "20px" }}>
          ...
          {/* 🔥 NEW BUTTON */}
          <button onClick={scrollToArrivals} style={btnStyle}>
            New Arrivals
          </button>

          <button onClick={scrollToLocation} style={btnOutline}>
            See Locations
          </button>
        ...
        <div style={gridStyle}>
          {products?.slice(0, 6).map((product) => (
            <div key={product.id} style={cardStyle}>
              ...
              <p style={{ color: "#aaa" }}>⭐ {product.rating}</p>
